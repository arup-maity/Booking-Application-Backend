...
adminCityRouter.post("/delete-cities/multiple", middleware_1.adminAuthentication, (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const body = yield c.req.json();
...
adminCityRouter.get("/all-cities", middleware_1.adminAuthentication, (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
adminCityRouter.get("/total-city-services", middleware_1.adminAuthentication, (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const totalCity = yield prisma_1.default.cities.count();
