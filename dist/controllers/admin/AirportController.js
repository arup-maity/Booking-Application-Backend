...
adminAirport.post("/delete-airports/multiple", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const body = yield c.req.json();
        const airports = yield prisma_1.default.airports.deleteMany({
            where: {
                id: { in: body.rows }
            }
        });
...
adminAirport.get("/total-airport-services", middleware_1.adminAuthentication, (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const totalAirport = yield prisma_1.default.airports.count();
