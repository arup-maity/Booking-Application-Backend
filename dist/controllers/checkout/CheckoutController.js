...
checkout.put('/update-payment-status/:id', (c) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        //
        const bookingDetails = yield prisma_1.default.bookingProcess.findUnique({
            where: {
                id: +id
            },
            include: {
        ...
        const booking = yield prisma_1.default.bookings.create({
            data: {
                userId: +(bookingDetails === null || bookingDetails === void 0 ? void 0 : bookingDetails.userId),
                ...
                payments: {
                    create: {
                        clientSecret: (_a = bookingDetails === null || bookingDetails === void 0 ? void 0 : bookingDetails.PaymentsProcess) === null || _a === void 0 ? void 0 : _a.clientSecret,
                        status: 'succeeded',
                    }
                }
            }
        ...
        if (!booking)
            return c.json({ success: false, message: 'Error creating booking' }, 409);
        yield prisma_1.default.bookingProcess.delete({
            where: { id: +id }
        });
