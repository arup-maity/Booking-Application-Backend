...
city.post("demo-city", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const indiaAirport = [
            {
                cityName: 'Mumbai',
...
city.post('create-city', (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (cityName)
            return c.json({ success: false, message: 'City Name already exists' }, 409);
        // create city
...
city.put("update-city/:id", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
city.get("read-city/:id", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = c.req.param("id");
...
city.delete("delete-city/:id", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = c.req.param("id");
...
city.get("all-cities", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
city.get("search-city", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const search = c.req.query('search');
        const cities = yield prisma_1.default.cities.findMany({
            // where: {
