...
adminFlight.post("/delete-flight/multiple", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const body = yield c.req.json();
        const flights = yield prisma_1.default.flights.deleteMany({
            where: {
                id: { in: body.rows }
            }
        });
...
adminFlight.get("all-flights", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const flights = yield prisma_1.default.flights.findMany(Object.assign({ include: {
                departureAirport: {
                    include: {
                        city: true
                    }
        ...
        const count = yield prisma_1.default.flights.count({
            where: conditions
        });
