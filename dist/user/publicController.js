...
user.get("/profile-details", middleware_1.authorization, (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
user.put("/profile-update", middleware_1.authorization, (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
user.put("/change-password", middleware_1.authorization, (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const body = yield c.req.json();
...
user.get("/bookings-list", middleware_1.authorization, (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield prisma_1.default.users.findUnique({
            where: {
                id: +c.user.id
