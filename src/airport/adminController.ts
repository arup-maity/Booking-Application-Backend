...
const airport = new Hono()

airport.post("demo-airport", async c => {
   try {
      const indiaAirport = [
         {
            cityName: 'Mumbai',
...
airport.post("create-airport", async c => {
   try {
...
airport.put("update-airport/:id", async c => {
   try {
...
airport.get("read-airport/:code", async c => {
   try {
...
airport.delete("delete-airport/:id", async c => {
   try {
      const id = c.req.param("id")
...
airport.get("all-airports", async c => {
   try {
...
airport.get("search-airport", async c => {
   try {
